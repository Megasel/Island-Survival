...
namespace YG
{
    public class TimerBeforeAdsYG : MonoBehaviour
    {
        ...
        public bool toolsPanelActivated;
        public bool upgradesPanelActivated;
        public bool restPanelActivated;
        private void Start()
        {
        ...
        IEnumerator CheckTimerAd()
        {
            while (true)
            {
                // Wait until isReady becomes true before starting the timer
                while (toolsPanelActivated || upgradesPanelActivated || restPanelActivated)
                {
